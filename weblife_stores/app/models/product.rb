class Product < ActiveRecord::Base
  ...
  def initialize_children
    inset.quote_request=self
    property.quote_request=self
    text_anchor.quote_request=self
    url_link.quote_request=self
  end 
                ...
                row.each do |cell|
                 ...
                 if count!=-1
                  ...
                  prod["url_link_attributes"]=params["product_#{count}"]["url_link"]
                   ...
                   products_array << Product.new(prod)
