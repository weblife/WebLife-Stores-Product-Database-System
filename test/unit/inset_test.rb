...
class InsetTest < ActiveSupport::TestCase
  ...
  def test_validations
    more_than_60_chars_string=generate_random_string(61)
    less_than_60_chars_string=generate_random_string(59)
    inset=Inset.new
    assert inset.valid?,"Empty fields are optional"
    ...
    assert_equal inset.errors.first[1],"Inset must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 2 must have at most 60 characters"

    inset=Inset.new
    inset.inset_3=more_than_60_chars_string
    assert !inset.valid?
    assert_equal inset.errors.first[0],"inset_3"
    assert_equal inset.errors.first[1],"Inset 3 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 4 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 5 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 6 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 7 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 8 must have at most 60 characters"
    ...
    assert_equal inset.errors.first[1],"Inset 9 must have at most 60 characters"
